...
let caption = `╭━━━[ *_تم التسجيل_* ]━━━━⬣
┃ *رقم* 
┃ ${name} ${user.registered === true ? 'ͧͧͧͦꙶͣͤ✓ʏʙ' : ''}
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
┃ *عمر* 
┃ *${age} اعوام*
╰━━━━━━━━━━━━━━━━━━⬣`
...
handler.tags = ['xp']
handler.command = /^(verify|register|verificar|تسجيل|verificado|verificada|verificarme)$/i
